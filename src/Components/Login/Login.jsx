...
export default function Login() {
  ...
  let valdateSchema = Yup.object({
    ...
    password: Yup.string().matches(/^[A-Z][a-zA-Z0-9]{6,}$/, 'password should start with uppercase,lowercase and at least 6 numbers '),
  })
  ...
  return <>
    <div className='w-75 mx-auto py-5'>
      ...
      <form className='shadow p-5 m-auto rounded-4' onSubmit={formik.handleSubmit}>
        ...
        <input className='form-control mb-2' placeholder='password should start with uppercase,lowercase and at least 6 numbers ' onBlur={formik.handleBlur} onChange={formik.handleChange} value={formik.values.password} type="password" id='password' name='password' />
